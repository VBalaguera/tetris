...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function control(e) {
      if(e.keyCode === 65) { //37 for left arrow
        moveLeft()
      } else if (e.keyCode === 87) { //38 for up arrow
        rotate()
      } else if (e.keyCode === 68) { //39 for right arrow
        moveRight()
      } else if (e.keyCode === 83) { //40 for down arrow
        moveDown()
      } else if (e.keyCode === 82) { //R assigned to RESTART!
        location.reload()
      }
    }
